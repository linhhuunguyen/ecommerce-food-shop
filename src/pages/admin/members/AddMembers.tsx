...
export default function AddMember() {
  ...
  const uploadImage = (files: any) => {
    ...
    formData.append('cloud_name', 'lhy');
    axios
      .post('https://api.cloudinary.com/v1_1/lhy/image/upload', formData)
      .then((response) => setAvatar(response.data.url));
  };
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (member.password === member.confirmPassword) {
      ...
      await dispatch(getMembers(token));
