...
const Telephone = () => {
  ...
  const selectCountryHandler = (e: any) => {
    setState({ ...state, countryCodeValue: e.target.value });
  };
  ...
  const countryFlagHandler = () => {
    ...
    setState({
      ...state,
      flagImg: `https://res.cloudinary.com/redq-inc/image/upload/v1600351535/pickbazar/bakery/Juice_q1dlke.png`
    });
  };
  return (
    <>
      <select
        ...
        defaultValue={state.countryCodeValue}
      >
        <option value="" hidden>
          Select Country
        </option>
      ...
      <input
        ...
        defaultValue={`state.countryCodeValue + state.phone`}
      />
    </>
  );
};
